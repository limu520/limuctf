                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    ...
                                    "[object Array]" !== Object.prototype.toString.call(e) && (e = [e]),
                                        e.map(function(e) {
                                            return e.name = e.name || e.title || "没有名称",//axui
                                                e.artist = e.artist || e.author || "匿名作者",//axui
                                ...
                                value: function(e) {
                                    if (this.player.events.trigger("listswitch", {
                                        ...
                                        this.player.template.pic.style.backgroundImage = t.cover ? "url('" + t.cover + "')": "",
                                            ...
                                            this.player.template.pic.href = t.href,//axui
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    this.player.lrc && this.player.lrc.clear(),
                                        ...
                                        this.player.template.pic.href = "##",//axui
                    ...
                    var s = function() {
                        ...
                        return i(e, [{
                            ...
                            value: function() {
                                ...
                                this.player.template.box.addEventListener("click",//axui
                                    function() {
                                        e.player.toggle()
                                    })
                            ...
                            },
                            {
                                ...
                                value: function() {
                                    ...
                                    var t = function(t) {
                                            ...
                                            default.getElementViewTop(e.player.template.volumeBar, e.player.options.fixed||e.player.options.bottom)) / e.player.template.volumeBar.clientHeight;
                                            n = Math.max(n, 0),
                                                n = Math.min(n, 1),
                                                e.player.volume(n)
                                        },
                                ...
                                value: function() {
                                    ...
                                    this.player.template.lrcButton.addEventListener("click",
                                        function() {
                                            ...
                                            if(e.player.options.bottom= !0){//axui
                                                e.player.template.lrcButton.classList.contains("aplayer-icon-lrc-inactivity") ? (e.player.template.lrcButton.classList.remove("aplayer-icon-lrc-inactivity"), e.player.lrc && e.player.lrc.hide()) : (e.player.template.lrcButton.classList.add("aplayer-icon-lrc-inactivity"), e.player.lrc && e.player.lrc.show())
                                            }else{
                                ...
                                value: function(e) {
                                    ...
                                    if (!this.parsed[e]) if (this.async) {
                                        ...
                                        n.onreadystatechange = function() {
                                            e === t.player.list.index && 4 === n.readyState && (n.status >= 200 && n.status < 300 || 304 === n.status ? t.parsed[e] = t.parse(n.responseText) : (t.player.notice("歌词加载失败: " + n.status), t.parsed[e] = [["00:00", "无效歌词"]]), t.container.innerHTML = (0, o.
                                                default)({
                                                lyrics:
                                                    t.parsed[e]
                                        ...
                                        n.open("get", i, !0),
                                            n.send(null)
                                    } else this.player.list.audios[e].lrc ? this.parsed[e] = this.parse(this.player.list.audios[e].lrc) : this.parsed[e] = [["00:00", "无效歌词"]];
                        ...
                        return i(e, [{
                            ...
                            value: function() {
                                ...
                                this.options.audio.length && (e = "random" === this.options.order ? this.options.audio[this.randomOrder[0]].cover: this.options.audio[0].cover),
                                    ...
                                    this.box = this.container.querySelector(".aplayer-pic"),//axui
                                    this.pic = this.container.querySelector(".aplayer-pic a"),//axui
                                    this.play = this.container.querySelector(".aplayer-pic .aplayer-button"),//axui
                    ...
                    Object.defineProperty(t, "__esModule", {
                        ...
                        t.
                            ...
                            var t = {
                                ...
                                volume: .7,
                                listFolded: e.fixed,
                                listMaxHeight: e.listmaxheight || "195px",//axui
                                audio: e.music || [],
                    ...
                    var m = [],
                        g = function() {
                            function e(t) {
                                ...
                                this.options.fixed && (this.container.classList.add("aplayer-fixed"),this.template.lrcWrap.classList.add("aplayer-lrc-hide"), this.template.body.style.width = this.template.body.offsetWidth + "px"),//axui
                                this.options.bottom && this.container.classList.add("aplayer-bottom"), //axui
                                this.options.bottom && this.template.lrcWrap.classList.add("aplayer-lrc-hide"),//axui
