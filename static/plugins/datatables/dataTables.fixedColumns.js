...
$.extend( FixedColumns.prototype , {
	...
	"_fnGridSetup": function ()
	{
			...
			$('<div class="DTFC_ScrollWrapper" style="position:relative; clear:both;">'+
				'<div class="DTFC_LeftWrapper" style="position:absolute; top:0; left:0;" aria-hidden="true">'+
					...
					'<div class="DTFC_LeftBodyWrapper" style="position:relative; top:0; left:0; height:0; overflow:hidden;">'+
						'<div class="DTFC_LeftBodyLiner" style="position:relative; top:0; left:0; overflow-y:scroll;overflow-x:hidden;"></div>'+//AXUI
					'</div>'+
        ...
        $('<div class="ax-clear"></div><div class="ax-break"></div>').insertBefore(nSWrapper);//AXUI
        $('<div class="ax-break"></div><div class="ax-clear"></div>').insertAfter(nSWrapper);//AXUI
		...
		if ( this.s.iRightColumns > 0 )
		{
            ...
            if (that.s.dt.oFeatures.bScroll==true) {
