...
(function() {
    ...
    var InfoBox =
        ...
        BMapLib.InfoBox = function(map, content, opts) {
            ...
            this._opts.offset =  opts.offset || new BMap.Size(0,46);//axui
            this._opts.boxClass = opts.boxClass || "ax-infoBox";
            this._opts.boxStyle = opts.boxStyle || {width: "400px"};
            this._opts.closeText = opts.closeText || "&times;";//axui
            this._opts.closeIconMargin = opts.closeIconMargin || "-10px -10px 0 0";
            this._opts.closeIconUrl = opts.closeIconUrl;//axui
    ...
    InfoBox.prototype.getOffset = function(){
        ...
        baidu.object.extend(InfoBox.prototype,{
            ...
            _getCloseIcon: function(){
                var img="<img src='"+ this._opts.closeIconUrl +"' align='right' style='position:absolute;z-index:2;right:0px;cursor:pointer;margin:"+ this._opts.closeIconMargin +"'/>";
                if(this._opts.closeIconUrl){
                    var close = img;//axui
                }else{
                    var close = "<span class='ax-close'>"+this._opts.closeText+"</span>";//axui
                }
                return close;//axui
            },
            /**
