...
Line.prototype._initializeSvg = function _initializeSvg(svg, opts) {
    ...
    if(opts.containerClass =='ax-progress-circle'){//axui
        opts.containerClass = 'ax-progress-line ax-row';
    }else if(opts.containerClass !='ax-progress-line'){
        opts.containerClass = opts.containerClass;
    }
    opts.text.autoStyleContainer = false;//axui
    svg.setAttribute('class', 'ax-col');//axui
};
...
SemiCircle.prototype._initializeSvg = function _initializeSvg(svg, opts) {
    ...
    if(opts.containerClass =='ax-progress-circle'){//axui
        opts.containerClass = 'ax-progress-circle ax-half';
    }else if(opts.containerClass !='ax-progress-circle'){
        opts.containerClass = opts.containerClass;
    }
};
...
var Shape = function Shape(container, opts) {
    ...
    this._opts = utils.extend({
        color: '#198cff',
        strokeWidth: 3,
        strokeLinecap:'round',//axui
        strokeLinejoin:'round',//axui
        trailColor: '#f0f0f0',
        strokeOpacity:1,//axui
        trailWidth: 3,
        fill: null,
        containerClass: 'ax-progress-circle',//axui
        text: {
            style: {
                color: null,
                position: 'absolute',
...
//axui
    if(this._container.className != this._opts.containerClass){
        this._container.className= this._container.className + ' ' + this._opts.containerClass;
    }else{
        this._container.className=this._opts.containerClass;
    }
//axui
...
//axui
    Shape.prototype.setClass = function setClass(newClass) {

        if(newClass && this._container.className.indexOf(newClass) == -1){
            this._container.className=this._container.className+' '+newClass;
        }

    };
    Shape.prototype.reClass = function reClass(newClass) {
        this._container.className=this._opts.containerClass;
    };
...
Shape.prototype._createSvgView = function _createSvgView(opts) {
    ...
    // the trail path
    if (opts.trailColor || opts.trailWidth || opts.trailLinecap) {
...
Shape.prototype._createTrail = function _createTrail(opts) {
    ...
    //mingfeg
    if (!newOpts.strokeLinecap) {
        newOpts.strokeLinecap = 'round';
    }
    if (!newOpts.strokeLinejoin) {
        newOpts.strokeLinejoin = 'round';
    }


    newOpts.color = newOpts.trailColor;
    newOpts.strokeWidth = newOpts.trailWidth;
    newOpts.strokeLinecap = newOpts.strokeLinecap;//axui
    newOpts.strokeLinejoin = newOpts.strokeLinejoin;//axui
...
Shape.prototype._createPathElement = function _createPathElement(pathString, opts) {
    ...
    path.setAttribute('stroke-linecap', opts.strokeLinecap);//axui
    path.setAttribute('stroke-linejoin', opts.strokeLinejoin);//axui
    path.setAttribute('stroke-opacity', opts.strokeOpacity);//axui
...
Shape.prototype._createTextContainer = function _createTextContainer(opts, container) {
    ...
    if (textStyle) {
        ...
        if (opts.text.autoStyleContainer) {
            ...
            textContainer.style.position = null;//axui
            textContainer.style.left = null;
            textContainer.style.top = null;
            textContainer.style.transform = null;
            textContainer.style.padding = null;
            textContainer.style.margin = null;
        }


        // Default text color to progress bar's color
        if (!textStyle.color) {
            textContainer.style.color = '';//axui
        }
    }
